	...
	PrimitiveTypes::Float32 customPercentage)
{
    ...
    if (strcmp(pSkelCPU->m_name, "StandIdle_hip.skela") == 0 && (animationIndex == 1 || animationIndex == 2 || animationIndex == 3)) {
        AnimationSlot slot(animationSetIndex, (animationIndex + m_debugAnimIdOffset), 0, (PrimitiveTypes::Float32)(anim.m_frames.m_size - 1), 0, 71, ACTIVE | additionalFlags /*| PARTIAL_BODY_ANIMATION | NOTIFY_ON_ANIMATION_END*/, weight);
